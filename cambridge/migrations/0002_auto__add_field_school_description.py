...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'School.description'
        db.add_column('cambridge_school', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'School.description'
        db.delete_column('cambridge_school', 'description')
