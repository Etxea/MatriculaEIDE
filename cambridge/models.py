...
class Registration(models.Model):
    ...
    eide_alumn = models.BooleanField(_('ALumno EIDE'), help_text=_('Haz click en el check si eres alumno/a de EIDE. En caso contrario rellena porfavor la siguiente casilla.'))
